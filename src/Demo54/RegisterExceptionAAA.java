 ...
 */
public class RegisterExceptionAAA extends Exception {
    static String [] array={"黄施予","黄时雨","黄思雨"};

    public RegisterExceptionAAA() { //添加一个空参数的构造方法
    }


    //添加一个带异常信息的构造方法
    public RegisterExceptionAAA(String message){
       super(message);
    }
    ...
    public static void CheckUsername(String name){
        for (String s:array
            ...
            if (name.equals(array)){
                ...
                try {
                    throw new RegisterExceptionAAA("用户名注册");
